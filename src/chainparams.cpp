...
{
    const char* pszTimestamp = "BBC News 15/Feb/2021 Ngozi Okonjo-Iweala named first female, African boss of WTO";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1613558533, 2088644824, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc212d6379890856198fbc6079304af0738af8bec3d235b14d34e0735e9c4b7de"));
        assert(genesis.hashMerkleRoot == uint256S("0x0693ba3b4c97ee54f3faf04a73b39bd52c46961552ce5ecddd41554d0bc80df7"));
        ...
        // vSeeds.emplace_back("seed-a.asusucoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.asusucointools.com");
        // vSeeds.emplace_back("dnsseed.asusucoinpool.org");
        ...
        checkpointData = {
            {
		{  0, uint256S("0xc212d6379890856198fbc6079304af0738af8bec3d235b14d34e0735e9c4b7de")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 481912, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb382fcc1c4c5ffa6212278623461985c67c7b59d7902dd99070a716bf61e6c85"));
        assert(genesis.hashMerkleRoot == uint256S("0x0693ba3b4c97ee54f3faf04a73b39bd52c46961552ce5ecddd41554d0bc80df7"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
//        vSeeds.emplace_back("testnet-seed.asusucointools.com");
  //      vSeeds.emplace_back("seed-b.asusucoin.loshan.co.uk");
    //    vSeeds.emplace_back("dnsseed-testnet.thrasher.io");
        ...
        checkpointData = {
            {
                {0, uint256S("0xb382fcc1c4c5ffa6212278623461985c67c7b59d7902dd99070a716bf61e6c85")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x68753a788ce7994fcc6f65f7cf5e557f40385f7512050cf23550a79bb89f2849"));
        assert(genesis.hashMerkleRoot == uint256S("0x0693ba3b4c97ee54f3faf04a73b39bd52c46961552ce5ecddd41554d0bc80df7"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x68753a788ce7994fcc6f65f7cf5e557f40385f7512050cf23550a79bb89f2849")},
            }
        };
