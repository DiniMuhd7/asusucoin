...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " asusucoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  asusucoin-tx [options] <hex-tx> [commands]  Update hex-encoded asusucoin transaction\n" +
            "or:     asusucoin-tx [options] -create [commands]   Create hex-encoded asusucoin transaction\n" +
            "\n";
