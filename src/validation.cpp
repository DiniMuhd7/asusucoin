...
#if defined(NDEBUG)
# error "Asusucoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Asusucoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ACN additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("asusucoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // See BIP30 and http://r6.ca/blog/20120116T005236Z.html for more information.
