# Support for Output Descriptors in Asusucoin Core

Since Asusucoin Core v0.17, there is support for Output Descriptors. This is a
...
on Asusucoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Asusucoin Core wallets, a convenience function `combo` is
