...
A number of changes to the way Asusucoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 tsaba per kB (0.00001 ACN). This is to prepare for dropping the minimum transaction fee to 0.1 tsaba per kB (0.0001 ACN) in the next release.
