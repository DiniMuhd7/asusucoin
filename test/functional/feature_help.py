...
"""Verify that starting asusucoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start asusucoin with -h for help text")
        ...
        self.log.info("Start asusucoin with -version for version information")
        ...
        self.log.info("Start asusucoind with -fakearg to make sure it does not start")
